...
\framebox{$z = a + i*b$  $\vert a, b, r \in \mathsf{R} und \theta \in [0,2\pi] \Leftrightarrow  z = r*(\cos(\theta)+i*\sin(\theta)) \Leftrightarrow r*e ^i\theta$}.\break
\newline
